...
public class BigRational extends Number implements Comparable<BigRational> {
    ...
    public BigRational mod(BigRational br) {
        return this.subtract(br.multiply(BigRational.valueOf(this.divide(br).intValue())));
    }
    ...
    public BigRational log(BigRational br) {
        return BigRational.valueOf(Math.log(this.doubleValue())/Math.log(br.doubleValue()));
    }
